        ...
        <div class="row">
            ...
            <div class="col-md-10">
                <div class="user_info">
                    ...
                    <p><input readonly placeholder="{{$currentuser->city}}"></p>
                    <p><input readonly placeholder="{{$currentuser->subject}}"></p>
                    <p><input readonly placeholder="{{$currentuser->level}}"></p>

                    <img class="img-thumbnail" src="{{URL::asset('avatars/'.$currentuser->filename)}}" alt="{{$currentuser->original_filename}}">
                </div>
